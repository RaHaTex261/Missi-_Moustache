...
public class AdminInterface extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jLabel2.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 18));
		jLabel2.setText("ID");
		...
		jLabel6.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 18));
		jLabel6.setText("ROLE");

		jTextField1.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 18));

		jTextField2.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 18));

		jTextField3.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 18));

		jTextField4.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 18));

		jPasswordField1.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 18));
		...
		jButton6.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 24));
		...
		// Définition de l'agencement horizontal des composants dans jPanel3
		jPanel3Layout.setHorizontalGroup(
		    jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		        .addGroup(jPanel3Layout.createSequentialGroup()
		            .addGap(16, 16, 16) // Marge gauche
		            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		                .addComponent(jLabel2) // Labels (champs de formulaire)
		                .addComponent(jLabel3)
		                .addComponent(jLabel4)
		                .addComponent(jLabel5)
		                .addComponent(jLabel6))
		            .addGap(23, 23, 23) // Espacement entre labels et champs
		            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		                .addGroup(jPanel3Layout.createSequentialGroup()
		                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		                    ...
		                    .addGap(170, 170, 170))
		                .addGroup(jPanel3Layout.createSequentialGroup()
		                    .addComponent(jButton2) // Boutons de contrôle
		                    .addGap(18, 18, 18)
		        ...
		        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
		            .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		            .addComponent(jButton7) // Bouton de fermeture
		            .addGap(47, 47, 47))
		);

		// Définition de l'agencement vertical des composants dans jPanel3
		jPanel3Layout.setVerticalGroup(
		    jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		        .addGroup(jPanel3Layout.createSequentialGroup()
		            .addComponent(jButton7) // Bouton de fermeture en haut
		            .addGap(32, 32, 32)
